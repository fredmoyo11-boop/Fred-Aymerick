...
public class AccountDTO {
    ...
    @Schema(description = "The type of car associated with the account( when the person is a driver)  .",allowableValues = {"SMALL", "MEDIUM", "DELUXE"} ,nullable = true,requiredMode = Schema.RequiredMode.NOT_REQUIRED)
